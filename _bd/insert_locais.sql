...
INSERT INTO locais (nome_local, endereco_local, get_id_cidade, get_id_genero_1, get_id_genero_2, get_id_genero_3, valor_local, horario_local, descricao_local, pathing_local) VALUES
  ...
  '10:00h - 23:00h (Dependendo dos Jogos)',
  'A Arena Mauro Sampaio é um estádio e arena multiuso de futebol localizado em Juazeiro do Norte, no estado brasileiro do Ceará. Inaugurado em 1 de maio de 1970, o estádio pertence à prefeitura de Juazeiro do Norte e é o local onde o Icasa e o Guarani de Juazeiro mandam os seus jogos.',
  'assets/img/locais/Arena Mauro Sampaio/Arena Mauro Sampaio');

-- Memorial Patativa do Assare
INSERT INTO locais (nome_local, endereco_local, get_id_cidade, get_id_genero_1, get_id_genero_2, get_id_genero_3, valor_local, horario_local, descricao_local, pathing_local) VALUES
  ('Memorial Patativa do Assaré',
  'R. Cel. Francisco Gomes, 80 - Assaré, CE, 63140-000',
  10,
  4, 3, null,
  'Acesso gratuito',
